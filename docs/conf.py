...
if find_import_spec("notfound"):
    ...
    notfound_urls_prefix = "/projects/yammbs/en/stable/"
    notfound_context = {
...
project = "YAMMBS"
copyright = "2016-2025 Open Force Field Initiative"
...
version = yammbs.__version__
# The full version, including alpha/beta/rc tags.
release = yammbs.__version__
...
html_theme_options = {
    ...
    "repo_url": "https://github.com/openforcefield/yammbs",
...
# Custom CSS files for notebook output styling
